...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="/assets/material/assets/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
</head>
...
<body class="bg-gray-200">
                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-2">Log in</h4>
                            ...
                            <div class="card-body">
                                <form role="form" class="text-start">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2">Log in</button>
                                    </div>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white text-lg-start">
                                ...
                                by
                                <a href="https://www.creative-tim.com" class="font-weight-bold text-white" target="_blank">PKL PT TELKOM WITEL LAMPUNG</a>
    ...
    <script src="/assets/material/assets/js/material-dashboard.min.js?v=3.0.0"></script>
</body>
