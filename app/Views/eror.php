...
<body class="error-page">
                ...
                <ul class="navbar-nav navbar-nav-hover mx-auto">
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                            Pages
                            <img src=" /assets/material/assets/img/down-arrow-white.svg  " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
                            <img src="/assets/material/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
                        </a>
                                ...
                                <div class="col-12 px-4 py-2">
                                    <div class="row">
                                        <div class="col-4 position-relative">
                                            ...
                                            <a href="/assets/material/pages/dashboards/analytics.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Analytics</span>
                                            </a>
                                            <a href="/assets/material/pages/dashboards/discover.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Discover</span>
                                            </a>
                                            <a href="/assets/material/pages/dashboards/sales.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Sales</span>
                                            </a>
                                            <a href="/assets/material/pages/dashboards/automotive.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Automotive</span>
                                            </a>
                                            <a href="/assets/material/pages/dashboards/smart-home.html" class="dropdown-item border-radius-md">
                                            ...
                                            <a href="/assets/material/pages/pages/users/reports.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Reports</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/users/new-user.html" class="dropdown-item border-radius-md">
                                        ...
                                        <div class="col-4 position-relative">
                                            ...
                                            <a href="/assets/material/pages/pages/profile/overview.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Overview</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/profile/messages.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Messages</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/profile/projects.html" class="dropdown-item border-radius-md">
                                            ...
                                            <a href="/assets/material/pages/pages/projects/general.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">General</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/projects/timeline.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Timeline</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/vr/vr-default.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Virtual Reality</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/projects/new-project.html" class="dropdown-item border-radius-md">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <a href="/assets/material/pages/pages/account/settings.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Settings</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/account/billing.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Billing</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/account/invoice.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Invoice</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/account/security.html" class="dropdown-item border-radius-md">
                                            ...
                                            <a href="/assets/material/pages/pages/pricing-page.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Pricing Page</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/rtl-page.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">RTL Page</span>
                                            </a>
                                            <a href="/assets/material/pages/pages/widgets.html" class="dropdown-item border-radius-md">
                        ...
                        <div class="dropdown-menu dropdown-menu-animation dropdown-md border-radius-xl p-3 mt-0 mt-lg-3" aria-labelledby="dropdownMenuAccount">
                                    ...
                                    <ul class="list-group">
                                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                            <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center mb-1 text-dark" id="dropdownSignIn">
                                                ...
                                                <span>Sign In</span>
                                                <img src="/assets/material/assets/img/down-arrow.svg" alt="down-arrow" class="arrow ms-auto">
                                            </a>
                                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignIn">
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/signin/basic.html">
                                                    <span>Basic</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/signin/cover.html">
                                                    <span>Cover</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md" href="/assets/material/pages/authentication/signin/illustration.html">
                                        ...
                                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                            ...
                                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignUp">
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/signup/basic.html">
                                                    <span>Basic</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/signup/cover.html">
                                                    <span>Cover</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md" href="/assets/material/pages/authentication/signup/illustration.html">
                                                    <span>Illustration</span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                            ...
                                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownPasswordReset">
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/reset/basic.html">
                                                    <span>Basic</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/reset/cover.html">
                                                    <span>Cover</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md" href="/assets/material/pages/authentication/reset/illustration.html">
                                                    <span>Illustration</span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                            ...
                                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownLock">
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/lock/basic.html">
                                                    <span>Basic</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/lock/cover.html">
                                                    <span>Cover</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md" href="/assets/material/pages/authentication/lock/illustration.html">
                                                    <span>Illustration</span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                            ...
                                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdown2fa">
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/verification/basic.html">
                                                    <span>Basic</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/verification/cover.html">
                                                    <span>Cover</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md" href="/assets/material/pages/authentication/verification/illustration.html">
                                                    <span>Illustration</span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                            ...
                                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownError">
                                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/assets/material/pages/authentication/error/404.html">
                                                    <span>404</span>
                                                </a>
                                                <a class="dropdown-item ps-3 border-radius-md" href="/assets/material/pages/authentication/error/500.html">
                                                    <span>500</span>
                                                </a>
                                            </div>
                                        </li>
                            ...
                            <div class="row d-lg-none">
                                <div class="col-12 d-flex justify-content-center flex-column">
                                    ...
                                    <a href="/assets/material/pages/authentication/signin/basic.html" class="dropdown-item border-radius-md ps-4">
                                        Basic
                                    </a>
                                    <a href="/assets/material/pages/authentication/signin/cover.html" class="dropdown-item border-radius-md ps-4">
                                        Cover
                                    </a>
                                    <a href="/assets/material/pages/authentication/signin/illustration.html" class="dropdown-item border-radius-md ps-4">
                                        Illustration
                                    </a>
                                    ...
                                    <a href="/assets/material/pages/authentication/signup/basic.html" class="dropdown-item border-radius-md ps-4">
                                        Basic
                                    </a>
                                    <a href="/assets/material/pages/authentication/signup/cover.html" class="dropdown-item border-radius-md ps-4">
                                        Cover
                                    </a>
                                    <a href="/assets/material/pages/authentication/signup/illustration.html" class="dropdown-item border-radius-md ps-4">
                                        Illustration
                                    </a>
                                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                        <i class="material-icons opacity-6 me-2 text-md">restart_alt</i>
                                    ...
                                    <a href="/assets/material/pages/authentication/reset/basic.html" class="dropdown-item border-radius-md ps-4">
                                        Basic
                                    </a>
                                    <a href="/assets/material/pages/authentication/reset/cover.html" class="dropdown-item border-radius-md ps-4">
                                        Cover
                                    </a>
                                    <a href="/assets/material/pages/authentication/reset/illustration.html" class="dropdown-item border-radius-md ps-4">
                                        Illustation
                                    </a>
                                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                        <i class="material-icons opacity-6 me-2 text-md">lock</i>
                                    ...
                                    <a href="/assets/material/pages/authentication/lock/basic.html" class="dropdown-item border-radius-md ps-4">
                                        Basic
                                    </a>
                                    <a href="/assets/material/pages/authentication/lock/cover.html" class="dropdown-item border-radius-md ps-4">
                                        Cover
                                    </a>
                                    <a href="/assets/material/pages/authentication/lock/illustration.html" class="dropdown-item border-radius-md ps-4">
                                        Illustration
                                    </a>
                                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                        <i class="material-icons opacity-6 me-2 text-md">admin_panel_settings</i>
                                    ...
                                    <a href="/assets/material/pages/authentication/verification/basic.html" class="dropdown-item border-radius-md ps-4">
                                        Basic
                                    </a>
                                    <a href="/assets/material/pages/authentication/verification/cover.html" class="dropdown-item border-radius-md ps-4">
                                        Cover
                                    </a>
                                    <a href="/assets/material/pages/authentication/verification/illustration.html" class="dropdown-item border-radius-md ps-4">
                                        Illustration
                                    </a>
                                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                        <i class="material-icons opacity-6 me-2 text-md">warning</i>
                                    ...
                                    <a href="/assets/material/pages/authentication/error/404.html" class="dropdown-item border-radius-md ps-4">
                                        404
                                    </a>
                                    <a href="/assets/material/pages/authentication/error/500.html" class="dropdown-item border-radius-md ps-4">
                                        500
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuBlocks">
                            <div class="d-none d-lg-block">
                                <ul class="list-group">
                                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                        <a class="dropdown-item border-radius-md mb-2" href="/assets/material/pages/applications/kanban.html">
                                    ...
                                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                        <a class="dropdown-item border-radius-md mb-2" href="/assets/material/pages/applications/wizard.html">
                                            <div class="d-flex align-items-center text-dark">
                                    ...
                                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                        <a class="dropdown-item border-radius-md mb-2" href="/assets/material/pages/applications/datatables.html">
                                            <div class="d-flex align-items-center text-dark">
                                    ...
                                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                        <a class="dropdown-item border-radius-md" href="/assets/material/pages/applications/calendar.html">
                                            <div class="d-flex align-items-center text-dark">
                            ...
                            <div class="row d-lg-none">
                                <div class="col-md-12">
                                    <a class="py-2 ps-3 border-radius-md" href="/assets/material/pages/applications/kanban.html">
                                        <div class="d-flex align-items-center text-dark">
                                            <i class="material-icons opacity-6 me-2 text-md">widgets</i>
                                            Kanban
                                        </div>
                                    </a>
                                    <a class="py-2 ps-3 border-radius-md" href="/assets/material/pages/applications/wizard.html">
                                        <div class="d-flex align-items-center text-dark">
                                            <i class="material-icons opacity-6 me-2 text-md">import_contacts</i>
                                            Wizard
                                        </div>
                                    </a>
                                    <a class="py-2 ps-3 border-radius-md" href="/assets/material/pages/applications/datatables.html">
                                        <div class="d-flex align-items-center text-dark">
                                            <i class="material-icons opacity-6 me-2 text-md">backup_table</i>
                                            DataTables
                                        </div>
                                    </a>
                                    <a class="py-2 ps-3 border-radius-md" href="/assets/material/pages/applications/calendar.html">
                                        <div class="d-flex align-items-center text-dark">
                                            <i class="material-icons opacity-6 me-2 text-md">event</i>
                                            Calendar
                                        </div>
                    ...
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-animation dropdown-lg p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuEcommerce">
                                ...
                                <div class="col-12 px-4 py-2">
                                    <div class="row">
                                        <div class="col-6 position-relative">
                                            ...
                                            <a href="/assets/material/pages/ecommerce/orders/list.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Order List</span>
                                            </a>
                                            <a href="/assets/material/pages/ecommerce/orders/details.html" class="dropdown-item border-radius-md">
                                            ...
                                            <a href="/assets/material/pages/ecommerce/overview.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Overview</span>
                                            </a>
                                            <a href="/assets/material/pages/ecommerce/referral.html" class="dropdown-item border-radius-md">
                                        ...
                                        <div class="col-6 position-relative">
                                            ...
                                            <a href="/assets/material/pages/ecommerce/products/new-product.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">New Product</span>
                                            </a>
                                            <a href="/assets/material/pages/ecommerce/products/edit-product.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Edit Product</span>
                                            </a>
                                            <a href="/assets/material/pages/ecommerce/products/product-page.html" class="dropdown-item border-radius-md">
                                                <span class="ps-2">Product Page</span>
                                            </a>
                                            <a href="/assets/material/pages/ecommerce/products/products-list.html" class="dropdown-item border-radius-md">
                            ...
                            <div class="d-lg-none">
                                ...
                                <a href="/assets/material/pages/pages/orders/details.html" class="dropdown-item border-radius-md">
                                    Order Details
                                </a>
                                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
                                    <i class="material-icons opacity-6 me-2 text-md">store</i>
                        ...
                        <div class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
                            ...
                            <div class="row d-lg-none">
                                <div class="col-md-12 g-0">
                                    <a class="dropdown-item border-radius-md text-dark" href="/assets/material/pages/about-us.html">
                                        <div class="d-flex align-items-center">
                                            <i class="material-icons opacity-6 me-2 text-md">article</i>
            ...
            <div class="container my-auto">
                <div class="row">
                    <div class="col-lg-12 m-auto text-center">
                        ...
                        <a href="/dashboard">
                            <button type="button" class="btn btn-outline-white mt-4">Go to Dashboard</button>
                        </a>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"78ac4dd09fb08799","version":"2022.11.3","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>
